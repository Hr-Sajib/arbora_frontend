...
const EditContainerPage = () => {
            ...
            await updateContainer({
                ...
                data: {
                    ...
                    containerProducts: container.containerProducts.map(prod => ({
                        ...
                        perCaseShippingCost: prod.perCaseShippingCost ? String(prod.perCaseShippingCost) : undefined,
    ...
    return (
        <div className="p-6">
                            ...
                            <table className="min-w-full border-collapse">
                                <thead>
                                    <tr className="bg-gray-100">
                                        ...
                                        <th className="border p-2 text-left">Per Case Shipping Cost</th>
                                    ...
                                    {container.containerProducts.map((prod) => (
                                        <tr key={prod._id} className="border-t">
                                            ...
                                            <td className="border p-2">
                                                <input
                                                    type="number"
                                                    value={prod.perCaseShippingCost || ''}
                                                    onChange={(e) => handleProductChange(prod._id, 'perCaseShippingCost', e.target.value ? Number(e.target.value) : '')}
                                                    className="border p-1 w-full rounded"
                                                />
                                            </td>
                                            <td className="border p-2">
            ...
            <div className='mt-36 text-sm text-gray-400'>
                <p className='mb-3 font-bold text-black'>⚠️ Note</p>
                <ul className='list-disc ml-5 font-semibold'>
                    <li>Be careful about Item Number/Product Number mentioned in container products</li>
                    <li>Per Case Cost of a product is Purchase Price / Quantity</li>
                    <li>Per Case Shipping Cost of a product is Container Shipping Cost / All Products Quantity Sum</li>
                </ul>
            </div>
        </div>
...
//                         quantity: Number(prod.quantity),
//                         perCaseCost: Number(prod.perCaseCost),
//                         perCaseShippingCost:  Number(prod.perCaseShippingCost),
//                         purchasePrice: Number(prod.purchasePrice),
//                         salesPrice: Number(prod.salesPrice)
//                         // packetSize is already a string, no conversion needed
//                     })),
...
//                                                     type="number"
//                                                     value={prod.perCaseCost || ''}
//                                                     onChange={(e) => handleProductChange(prod._id, 'perCaseShippingCost', e.target.value ? Number(e.target.value) : 0)}
//                                                     className="border p-1 w-full rounded"
//                                                 />
//                                             </td>
//                                             <td className="border p-2">
